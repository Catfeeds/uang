...
//        console.log(num1, num2, num3);
    if (num1 < 0 || isNaN(num1)) {
            dialog.alert("masukkan jumlah pinjaman yang benar");
            // dialog.alert("请填写正确的贷款总额！");
            return false;
    }
    if (num2 == 0 ||isNaN(num2)) {
        dialog.alert("masukkan bunga bulanan yang benar");
    ...
    if (num3 == 0 ||isNaN(num3)) {
        dialog.alert("masukkan jumlah waktu jatuh tempo yang benar");
    ...
    if (sss == '1') {
        ...
        for (var i = 1; i < Number(num3) + 1; i++) {
            ...
            //循环输出列表
            var addRow = '<li id="ssss"><ul><li class="fl">' + hke + '</li><li class="fl">' + bj + '</li><li class="fl">' + lx + '</li><li class="fl">' + i + '</li></ul></li>';
            $("#tab1").append(addRow);
            qcye = qmye;
            lxzj += Number(lx);
        }
